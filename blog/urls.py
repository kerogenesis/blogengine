...
urlpatterns = [
    ...
    path('all/<str:slug>/comments/<str:id>/mark/', CommentMark.as_view(), name='comment_mark_url'),
    path('all/<str:slug>/comments/<str:id>/delete/', CommentDelete.as_view(), name='comment_delete_url'),
